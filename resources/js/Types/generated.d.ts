...
export enum Classification { 'ENTERTAINMENT' = Classification::ENTERTAINMENT, 'ECOMMERCE' = 'Ecommerce', 'OTHER' = 'Other' };
export enum Contributions { 'DEVOPS' = 'DEVOPS', 'DESIGN' = 'DESIGN', 'FRONTEND' = 'FRONTEND', 'BACKEND' = 'BACKEND', 'IDEATION' = 'IDEATION', 'UX' = 'UX' };
export enum Segments { 'LARAVEL' = 'LARAVEL', 'VUE_JS' = 'VUE JS', 'REACT' = 'REACT', 'WORDPRESS' = 'WORDPRESS', 'HEADLESS_WORDPRESS' = 'HEADLESS WORDPRESS', 'SHOPIFY' = 'SHOPIFY', 'THREEJS' = 'THREE.JS', 'AWS' = 'AWS', 'INERTIAJS' = 'INERTIA.JS', 'GSAP' = 'GSAP', 'WEBGL' = 'WEBGL', 'CUSTOM_CMS' = 'CUSTOM CMS', 'TWILL' = 'TWILL CMS', 'STATIC' = 'STATIC', 'TAILWIND' = 'TAILWIND', 'SCSS' = 'SCSS', 'SSR' = 'SSR', 'ROOTS_BEDROCK' = 'ROOTS BEDROCK', 'ROOTS_SAGE' = 'ROOTS SAGE', 'SEGMENT' = 'SEGMENT', 'LOCALIZED' = 'LOCALIZED', 'GRIDSOME' = 'GRIDSOME', 'NEXT_JS' = 'NEXT.JS', 'SALESFORCE' = 'SALESFORCE API', 'KLAVIYO' = 'KLAVIYO' };
}
