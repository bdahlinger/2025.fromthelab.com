...
`)}function sv(r,t){let e;switch(t){case cd:e="Linear";break;case ud:e="Reinhard";break;case hd:e="Cineon";break;case fd:e="ACESFilmic";break;case pd:e="AgX";break;case md:e="Neutral";break;case dd:e="Custom";break;default:console.warn("THREE.WebGLProgram: Unsupported toneMapping:",t),e="Linear"}return"vec3 "+r+"( vec3 color ) { return "+e+"ToneMapping( color ); }"}const qs=new U;function av(){$t.getLuminanceCoefficients(qs);const r=qs.x.toFixed(4),t=qs.y.toFixed(4),e=qs.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${r}, ${t}, ${e} );`,"	return dot( weights, rgb );","}"].join(`
...
#define LOW_PRECISION`),t}function mv(r){let t="SHADOWMAP_TYPE_BASIC";return r.shadowMapType===Vu?t="SHADOWMAP_TYPE_PCF":r.shadowMapType===Hf?t="SHADOWMAP_TYPE_PCF_SOFT":r.shadowMapType===On&&(t="SHADOWMAP_TYPE_VSM"),t}function _v(r){let t="ENVMAP_TYPE_CUBE";if(r.envMap)switch(r.envMapMode){case xr:case Mr:t="ENVMAP_TYPE_CUBE";break;case ga:t="ENVMAP_TYPE_CUBE_UV";break}return t}function gv(r){let t="ENVMAP_MODE_REFLECTION";if(r.envMap)switch(r.envMapMode){case Mr:t="ENVMAP_MODE_REFRACTION";break}return t}function vv(r){let t="ENVMAP_BLENDING_NONE";if(r.envMap)switch(r.combine){case Rl:t="ENVMAP_BLENDING_MULTIPLY";break;case od:t="ENVMAP_BLENDING_MIX";break;case ld:t="ENVMAP_BLENDING_ADD";break}return t}function xv(r){const t=r.envMapCubeUVHeight;if(t===null)return null;const e=Math.log2(t)-2,n=1/t;return{texelWidth:1/(3*Math.max(Math.pow(2,e),7*16)),texelHeight:n,maxMip:e}}function Mv(r,t,e,n){const i=r.getContext(),s=e.defines;let a=e.vertexShader,o=e.fragmentShader;const l=mv(e),c=_v(e),u=gv(e),h=vv(e),f=xv(e),d=ov(e),g=lv(s),_=i.createProgram();let m,p,T=e.glslVersion?"#version "+e.glslVersion+`
