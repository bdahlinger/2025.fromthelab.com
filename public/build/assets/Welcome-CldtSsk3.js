...
`)+`
`+m);const x=M+p+o,v=M+m+a,b=ad(i,i.VERTEX_SHADER,x),w=ad(i,i.FRAGMENT_SHADER,v);i.attachShader(_,b),i.attachShader(_,w),e.index0AttributeName!==void 0?i.bindAttribLocation(_,0,e.index0AttributeName):e.morphTargets===!0&&i.bindAttribLocation(_,0,"position"),i.linkProgram(_);function T(I){if(r.debug.checkShaderErrors){const F=i.getProgramInfoLog(_).trim(),G=i.getShaderInfoLog(b).trim(),Y=i.getShaderInfoLog(w).trim();let tt=!0,V=!0;if(i.getProgramParameter(_,i.LINK_STATUS)===!1)if(tt=!1,typeof r.debug.onShaderError=="function")r.debug.onShaderError(i,_,b,w);else{const X=cd(i,b,"vertex"),H=cd(i,w,"fragment");console.error("THREE.WebGLProgram: Shader Error "+i.getError()+" - VALIDATE_STATUS "+i.getProgramParameter(_,i.VALIDATE_STATUS)+`
 ...
 * Club GSAP members, the agreement issued with that membership.
 * @author: Jack Doyle, jack@greensock.com
*/var sn,vl,Jn,gr,vr,Zs,qm,Hr,Vo,Zm,Ki,gi,$m,Jm=function(){return sn||typeof window<"u"&&(sn=window.gsap)&&sn.registerPlugin&&sn},Km=1,Bs=[],se=[],Ni=[],Go=Date.now,sh=function(t,e){return e},oE=function(){var t=Vo.core,e=t.bridge||{},n=t._scrollers,i=t._proxies;n.push.apply(n,se),i.push.apply(i,Ni),se=n,Ni=i,sh=function(o,a){return e[o](a)}},Mr=function(t,e){return~Ni.indexOf(t)&&Ni[Ni.indexOf(t)+1][e]},Wo=function(t){return!!~Zm.indexOf(t)},yn=function(t,e,n,i,s){return t.addEventListener(e,n,{passive:i!==!1,capture:!!s})},vn=function(t,e,n,i){return t.removeEventListener(e,n,!!i)},Ka="scrollLeft",ja="scrollTop",oh=function(){return Ki&&Ki.isPressed||se.cache++},Bl=function(t,e){var n=function i(s){if(s||s===0){Km&&(Jn.history.scrollRestoration="manual");var o=Ki&&Ki.isPressed;s=i.v=Math.round(s)||(Ki&&Ki.iOS?1:0),t(s),i.cacheID=se.cache,o&&sh("ss",s)}else(e||se.cache!==i.cacheID||sh("ref"))&&(i.cacheID=se.cache,i.v=t());return i.v+i.offset};return n.offset=0,t&&n},wn={s:Ka,p:"left",p2:"Left",os:"right",os2:"Right",d:"width",d2:"Width",a:"x",sc:Bl(function(r){return arguments.length?Jn.scrollTo(r,Ze.sc()):Jn.pageXOffset||gr[Ka]||vr[Ka]||Zs[Ka]||0})},Ze={s:ja,p:"top",p2:"Top",os:"bottom",os2:"Bottom",d:"height",d2:"Height",a:"y",op:wn,sc:Bl(function(r){return arguments.length?Jn.scrollTo(wn.sc(),r):Jn.pageYOffset||gr[ja]||vr[ja]||Zs[ja]||0})},Pn=function(t,e){return(e&&e._ctx&&e._ctx.selector||sn.utils.toArray)(t)[0]||(typeof t=="string"&&sn.config().nullTargetWarn!==!1?console.warn("Element not found:",t):null)},wr=function(t,e){var n=e.s,i=e.sc;Wo(t)&&(t=gr.scrollingElement||vr);var s=se.indexOf(t),o=i===Ze.sc?1:2;!~s&&(s=se.push(t)-1),se[s+o]||yn(t,"scroll",oh);var a=se[s+o],l=a||(se[s+o]=Bl(Mr(t,n),!0)||(Wo(t)?i:Bl(function(c){return arguments.length?t[n]=c:t[n]})));return l.target=t,a||(l.smooth=sn.getProperty(t,"scrollBehavior")==="smooth"),l},ah=function(t,e,n){var i=t,s=t,o=Go(),a=o,l=e||50,c=Math.max(500,l*3),u=function(g,_){var p=Go();_||p-o>l?(s=i,i=g,a=o,o=p):n?i+=g:i=s+(g-s)/(p-a)*(o-a)},h=function(){s=i=n?0:i,a=o=0},f=function(g){var _=a,p=s,m=Go();return(g||g===0)&&g!==i&&u(g),o===a||m-a>c?0:(i+(n?p:-p))/((n?m:o)-_)*1e3};return{update:u,reset:h,getVelocity:f}},wo=function(t,e){return e&&!t._gsapAllow&&t.preventDefault(),t.changedTouches?t.changedTouches[0]:t},Fd=function(t){var e=Math.max.apply(Math,t),n=Math.min.apply(Math,t);return Math.abs(e)>=Math.abs(n)?e:n},jm=function(){Vo=sn.core.globals().ScrollTrigger,Vo&&Vo.core&&oE()},Qm=function(t){return sn=t||Jm(),!vl&&sn&&typeof document<"u"&&document.body&&(Jn=window,gr=document,vr=gr.documentElement,Zs=gr.body,Zm=[Jn,gr,vr,Zs],sn.utils.clamp,$m=sn.core.context||function(){},Hr="onpointerenter"in Zs?"pointer":"mouse",qm=Fe.isTouch=Jn.matchMedia&&Jn.matchMedia("(hover: none), (pointer: coarse)").matches?1:"ontouchstart"in Jn||navigator.maxTouchPoints>0||navigator.msMaxTouchPoints>0?2:0,gi=Fe.eventTypes=("ontouchstart"in vr?"touchstart,touchmove,touchcancel,touchend":"onpointerdown"in vr?"pointerdown,pointermove,pointercancel,pointerup":"mousedown,mousemove,mouseup,mouseup").split(","),setTimeout(function(){return Km=0},500),jm(),vl=1),vl};wn.op=Ze;se.cache=0;var Fe=function(){function r(e){this.init(e)}var t=r.prototype;return t.init=function(n){vl||Qm(sn)||console.warn("Please gsap.registerPlugin(Observer)"),Vo||jm();var i=n.tolerance,s=n.dragMinimum,o=n.type,a=n.target,l=n.lineHeight,c=n.debounce,u=n.preventDefault,h=n.onStop,f=n.onStopDelay,d=n.ignore,g=n.wheelSpeed,_=n.event,p=n.onDragStart,m=n.onDragEnd,M=n.onDrag,x=n.onPress,v=n.onRelease,b=n.onRight,w=n.onLeft,T=n.onUp,R=n.onDown,S=n.onChangeX,y=n.onChangeY,I=n.onChange,F=n.onToggleX,G=n.onToggleY,Y=n.onHover,tt=n.onHoverEnd,V=n.onMove,X=n.ignoreCheck,H=n.isNormalizer,ht=n.onGestureStart,B=n.onGestureEnd,_t=n.onWheel,Rt=n.onEnable,Vt=n.onDisable,N=n.onClick,U=n.scrollSpeed,L=n.capture,C=n.allowClicks,Q=n.lockAxis,ft=n.onLockAxis;this.target=a=Pn(a)||vr,this.vars=n,d&&(d=sn.utils.toArray(d)),i=i||1e-9,s=s||0,g=g||1,U=U||1,o=o||"wheel,touch,pointer",c=c!==!1,l||(l=parseFloat(Jn.getComputedStyle(Zs).lineHeight)||22);var J,dt,et,q,E,st,nt,z=this,k=0,O=0,lt=n.passive||!u&&n.passive!==!1,P=wr(a,wn),A=wr(a,Ze),K=P(),it=A(),at=~o.indexOf("touch")&&!~o.indexOf("pointer")&&gi[0]==="pointerdown",ct=Wo(a),yt=a.ownerDocument||gr,xt=[0,0,0],St=[0,0,0],Bt=0,gt=function(){return Bt=Go()},Mt=function(Ft,jt){return(z.event=Ft)&&d&&~d.indexOf(Ft.target)||jt&&at&&Ft.pointerType!=="touch"||X&&X(Ft,jt)},Nt=function(){z._vx.reset(),z._vy.reset(),dt.pause(),h&&h(z)},Ot=function(){var Ft=z.deltaX=Fd(xt),jt=z.deltaY=Fd(St),wt=Math.abs(Ft)>=i,Jt=Math.abs(jt)>=i;I&&(wt||Jt)&&I(z,Ft,jt,xt,St),wt&&(b&&z.deltaX>0&&b(z),w&&z.deltaX<0&&w(z),S&&S(z),F&&z.deltaX<0!=k<0&&F(z),k=z.deltaX,xt[0]=xt[1]=xt[2]=0),Jt&&(R&&z.deltaY>0&&R(z),T&&z.deltaY<0&&T(z),y&&y(z),G&&z.deltaY<0!=O<0&&G(z),O=z.deltaY,St[0]=St[1]=St[2]=0),(q||et)&&(V&&V(z),et&&(p&&et===1&&p(z),M&&M(z),et=0),q=!1),st&&!(st=!1)&&ft&&ft(z),E&&(_t(z),E=!1),J=0},Pt=function(Ft,jt,wt){xt[wt]+=Ft,St[wt]+=jt,z._vx.update(Ft),z._vy.update(jt),c?J||(J=requestAnimationFrame(Ot)):Ot()},Kt=function(Ft,jt){Q&&!nt&&(z.axis=nt=Math.abs(Ft)>Math.abs(jt)?"x":"y",st=!0),nt!=="y"&&(xt[2]+=Ft,z._vx.update(Ft,!0)),nt!=="x"&&(St[2]+=jt,z._vy.update(jt,!0)),c?J||(J=requestAnimationFrame(Ot)):Ot()},Yt=function(Ft){if(!Mt(Ft,1)){Ft=wo(Ft,u);var jt=Ft.clientX,wt=Ft.clientY,Jt=jt-z.x,zt=wt-z.y,Zt=z.isDragging;z.x=jt,z.y=wt,(Zt||(Jt||zt)&&(Math.abs(z.startX-jt)>=s||Math.abs(z.startY-wt)>=s))&&(et=Zt?2:1,Zt||(z.isDragging=!0),Kt(Jt,zt))}},le=z.onPress=function(Dt){Mt(Dt,1)||Dt&&Dt.button||(z.axis=nt=null,dt.pause(),z.isPressed=!0,Dt=wo(Dt),k=O=0,z.startX=z.x=Dt.clientX,z.startY=z.y=Dt.clientY,z._vx.reset(),z._vy.reset(),yn(H?a:yt,gi[1],Yt,lt,!0),z.deltaX=z.deltaY=0,x&&x(z))},W=z.onRelease=function(Dt){if(!Mt(Dt,1)){vn(H?a:yt,gi[1],Yt,!0);var Ft=!isNaN(z.y-z.startY),jt=z.isDragging,wt=jt&&(Math.abs(z.x-z.startX)>3||Math.abs(z.y-z.startY)>3),Jt=wo(Dt);!wt&&Ft&&(z._vx.reset(),z._vy.reset(),u&&C&&sn.delayedCall(.08,function(){if(Go()-Bt>300&&!Dt.defaultPrevented){if(Dt.target.click)Dt.target.click();else if(yt.createEvent){var zt=yt.createEvent("MouseEvents");zt.initMouseEvent("click",!0,!0,Jn,1,Jt.screenX,Jt.screenY,Jt.clientX,Jt.clientY,!1,!1,!1,!1,0,null),Dt.target.dispatchEvent(zt)}}})),z.isDragging=z.isGesturing=z.isPressed=!1,h&&jt&&!H&&dt.restart(!0),et&&Ot(),m&&jt&&m(z),v&&v(z,wt)}},Et=function(Ft){return Ft.touches&&Ft.touches.length>1&&(z.isGesturing=!0)&&ht(Ft,z.isDragging)},ut=function(){return(z.isGesturing=!1)||B(z)},pt=function(Ft){if(!Mt(Ft)){var jt=P(),wt=A();Pt((jt-K)*U,(wt-it)*U,1),K=jt,it=wt,h&&dt.restart(!0)}},Tt=function(Ft){if(!Mt(Ft)){Ft=wo(Ft,u),_t&&(E=!0);var jt=(Ft.deltaMode===1?l:Ft.deltaMode===2?Jn.innerHeight:1)*g;Pt(Ft.deltaX*jt,Ft.deltaY*jt,0),h&&!H&&dt.restart(!0)}},bt=function(Ft){if(!Mt(Ft)){var jt=Ft.clientX,wt=Ft.clientY,Jt=jt-z.x,zt=wt-z.y;z.x=jt,z.y=wt,q=!0,h&&dt.restart(!0),(Jt||zt)&&Kt(Jt,zt)}},qt=function(Ft){z.event=Ft,Y(z)},ce=function(Ft){z.event=Ft,tt(z)},De=function(Ft){return Mt(Ft)||wo(Ft,u)&&N(z)};dt=z._dc=sn.delayedCall(f||.25,Nt).pause(),z.deltaX=z.deltaY=0,z._vx=ah(0,50,!0),z._vy=ah(0,50,!0),z.scrollX=P,z.scrollY=A,z.isDragging=z.isGesturing=z.isPressed=!1,$m(this),z.enable=function(Dt){return z.isEnabled||(yn(ct?yt:a,"scroll",oh),o.indexOf("scroll")>=0&&yn(ct?yt:a,"scroll",pt,lt,L),o.indexOf("wheel")>=0&&yn(a,"wheel",Tt,lt,L),(o.indexOf("touch")>=0&&qm||o.indexOf("pointer")>=0)&&(yn(a,gi[0],le,lt,L),yn(yt,gi[2],W),yn(yt,gi[3],W),C&&yn(a,"click",gt,!0,!0),N&&yn(a,"click",De),ht&&yn(yt,"gesturestart",Et),B&&yn(yt,"gestureend",ut),Y&&yn(a,Hr+"enter",qt),tt&&yn(a,Hr+"leave",ce),V&&yn(a,Hr+"move",bt)),z.isEnabled=!0,z.isDragging=z.isGesturing=z.isPressed=q=et=!1,z._vx.reset(),z._vy.reset(),K=P(),it=A(),Dt&&Dt.type&&le(Dt),Rt&&Rt(z)),z},z.disable=function(){z.isEnabled&&(Bs.filter(function(Dt){return Dt!==z&&Wo(Dt.target)}).length||vn(ct?yt:a,"scroll",oh),z.isPressed&&(z._vx.reset(),z._vy.reset(),vn(H?a:yt,gi[1],Yt,!0)),vn(ct?yt:a,"scroll",pt,L),vn(a,"wheel",Tt,L),vn(a,gi[0],le,L),vn(yt,gi[2],W),vn(yt,gi[3],W),vn(a,"click",gt,!0),vn(a,"click",De),vn(yt,"gesturestart",Et),vn(yt,"gestureend",ut),vn(a,Hr+"enter",qt),vn(a,Hr+"leave",ce),vn(a,Hr+"move",bt),z.isEnabled=z.isPressed=z.isDragging=!1,Vt&&Vt(z))},z.kill=z.revert=function(){z.disable();var Dt=Bs.indexOf(z);Dt>=0&&Bs.splice(Dt,1),Ki===z&&(Ki=0)},Bs.push(z),H&&Wo(a)&&(Ki=z),z.enable(_)},sE(r,[{key:"velocityX",get:function(){return this._vx.getVelocity()}},{key:"velocityY",get:function(){return this._vy.getVelocity()}}]),r}();Fe.version="3.12.7";Fe.create=function(r){return new Fe(r)};Fe.register=Qm;Fe.getAll=function(){return Bs.slice()};Fe.getById=function(r){return Bs.filter(function(t){return t.vars.id===r})[0]};Jm()&&sn.registerPlugin(Fe);/*!
